...
require('lazy').setup({
  ...
  },
  {
    ...
    dependencies = {
      ...
      { 'mason-org/mason.nvim', opts = {}, version = '1.*' },
      {
  ...
  -- GitHub Copilot
  {
    ...
    config = function()
      ...
      -- Cycle suggestions
      vim.keymap.set('i', '<leader>cn', '<Plug>(copilot-next)', { desc = 'Copilot Next' })
      vim.keymap.set('i', '<leader>cp', '<Plug>(copilot-previous)', { desc = 'Copilot Previous' })

      -- Dismiss suggestion
      vim.keymap.set('i', '<leader>cd', '<Plug>(copilot-dismiss)', { desc = 'Copilot Dismiss' })
